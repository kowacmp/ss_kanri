# -*- coding:utf-8 -*-
class CreateDPriceChecks2 < ActiveRecord::Migration
  def up
    # 既に作成済みのテーブルは破棄する
    ...
    create_table :d_price_checks do |t|
      ...
      t.string :dis1_1_rg,   :limit => 5
      t.string :dis1_1_hg,   :limit => 5
      t.string :dis1_1_kg,   :limit => 5
      t.string :dis1_1_tg,   :limit => 5
      
      t.string  :dis1_2_name, :limit => 10
      t.integer :dis1_2_code
      t.string  :dis1_2_rg,   :limit => 5
      t.string  :dis1_2_hg,   :limit => 5
      t.string  :dis1_2_kg,   :limit => 5
      t.string  :dis1_2_tg,   :limit => 5
      
      t.string :dis1_3_name, :limit => 10
      t.string :dis1_3_rg,   :limit => 5
      t.string :dis1_3_hg,   :limit => 5
      t.string :dis1_3_kg,   :limit => 5
      t.string :dis1_3_tg,   :limit => 5
      
      t.string :dis2_name,   :limit => 5
      
      t.string :dis2_1_name, :limit => 10
      t.string :dis2_1_rg,   :limit => 5
      t.string :dis2_1_hg,   :limit => 5
      t.string :dis2_1_kg,   :limit => 5
      t.string :dis2_1_tg,   :limit => 5
      
      t.string  :dis2_2_name, :limit => 10
      t.integer :dis2_2_code
      t.string  :dis2_2_rg,   :limit => 5
      t.string  :dis2_2_hg,   :limit => 5
      t.string  :dis2_2_kg,   :limit => 5
      t.string  :dis2_2_tg,   :limit => 5
      
      t.string :dis2_3_name, :limit => 10
      t.string :dis2_3_rg,   :limit => 5
      t.string :dis2_3_hg,   :limit => 5
      t.string :dis2_3_kg,   :limit => 5
      t.string :dis2_3_tg,   :limit => 5
