# -*- coding:utf-8 -*
class AddColumnDWashpurikaReports < ActiveRecord::Migration
  def up
    
    execute "drop table d_washpurika_reports "
    ...
    execute "COMMENT ON COLUMN d_washpurika_reports.league       IS 'リーグ'"
    execute "COMMENT ON COLUMN d_washpurika_reports.before_rank  IS 'リーグ内順位'"
    execute "COMMENT ON COLUMN d_washpurika_reports.total_point  IS '獲得pt'"
